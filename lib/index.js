...
var Captweet = function () {
  ...
  _createClass(Captweet, [{
    ...
    value: function get_whole_timeline(user, since_id) {
      var captweet = this;
      return (0, _co2.default)(regeneratorRuntime.mark(function _callee() {
        var max_id, count, nbr, total, timeline, query, _ref, tweets, min, max;

        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                max_id = void 0, count = 200, nbr = count, total = void 0, timeline = [];
                query = {
    ...
    key: 'get_first_tweets_of_timeline',
    value: function get_first_tweets_of_timeline(query) {
      var captweet = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                return _context2.abrupt('return', { tweets: tweets, min: min, max: max });
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                data = _context3.sent;
                return _context3.abrupt('return', data.id_str);
